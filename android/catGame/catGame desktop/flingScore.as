package  {
	...
	public class flingScore extends MovieClip {
		...
		public function flingScore(score:Number, total:Number) {
			scoreContinue.addEventListener(MouseEvent.MOUSE_DOWN, continue_button_clicked);
			if(score == 0) {
		...
		public function unloadScore() {
			scoreContinue.removeEventListener(MouseEvent.MOUSE_DOWN, continue_button_clicked);
		}
		
		public function continue_button_clicked(event:MouseEvent) {
