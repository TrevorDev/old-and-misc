package  {
	...
	public class mouseFling extends MovieClip {
		...
		public function mouseFling(uid:uint) {
			...
			this.addEventListener(MouseEvent.MOUSE_DOWN, fl_TouchBeginHandler);
			this.addEventListener(MouseEvent.MOUSE_UP, fl_TouchEndHandler);
		...
		function updateCounter(evt:Event):void
		{
			...
			if(this.hitTestObject(flingScreen.screen.wallwin)) {
				...
				this.removeEventListener(MouseEvent.MOUSE_DOWN, fl_TouchBeginHandler);
				this.removeEventListener(MouseEvent.MOUSE_UP, fl_TouchEndHandler);
		...
		function fl_TouchBeginHandler(event:MouseEvent):void
		{
		...
		function fl_TouchEndHandler(event:MouseEvent):void
		{
			holding = false;
			timeTaken = counter;
			finalX = this.x;
