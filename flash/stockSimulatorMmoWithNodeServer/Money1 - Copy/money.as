package 
{
	...
	public class money extends MovieClip
	{
		...
		public var stock_screen:stockScreen;
		...
		{
			stock_screen = new stockScreen();
			money.main.removeAllScreens();
			money.main.addChildAt(stock_screen, 0);
		}
		...
		public function remove_stock()
		{
			if (stock_screen)
			{
				if (main.contains(stock_screen))
				{
					stock_screen.removeEventListener(MouseEvent.CLICK, stock_screen.rightClicked);
					stock_screen.removeEventListener(MouseEvent.CLICK, stock_screen.backClicked);
					stock_screen.removeEventListener(MouseEvent.CLICK, stock_screen.leftClicked);
					removeChild(stock_screen);
					stock_screen = null;
				}
			}
		}
