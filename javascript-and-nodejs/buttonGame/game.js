function onLoading() {
    ...
    function cashMeter(placeHolder) {
        ...
        this.subtract=function(val) {
            this.value = bigint_subtract(this.value, val);
            this.update();
        }
        this.update=function(){
    ...
    var gainInterestLevelB = document.getElementsByClassName("gainInterestLevelB");
    ...
    var cashM = new cashMeter(scoreLabel);
    var graphPlaceHolders = document.getElementsByClassName("demo-placeholder");
    var graphs = [];
    for(var x = 0 ;x<graphPlaceHolders.length;x++){
        graphs[x]=new graph(graphPlaceHolders[x]);
    }
